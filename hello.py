...
# =========================
# ✅ ORDEM DE DISTRIBUIÇÃO POR HUB (prioridade)
# =========================
...
def order_hubs(hubs_iterable):
    """
    Ordena hubs pela prioridade definida; hubs não mapeados vão pro final.
    Entre hubs não mapeados, ordena alfabeticamente para manter determinismo.
    """
